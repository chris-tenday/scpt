<template>
  <div>
    <Header page-title="Nous contacter"/>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6">
            <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
              <form @submit.prevent="sendContact('info@ocpt.cd')">
                <div class="row g-3">
                  <div class="col-xl-12">
    ...
    <div id="services" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
      <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
          <h1 class="mb-0">Nos coordonnées</h1>
        </div>
        <div class="row g-5">
          ...
          <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
            <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
              ...
              <p class="m-0">Envoyez-nous un e-mail pour obtenir de l’aide concernant un produit ou un service de la OCPT</p>
              <a style="display: none;" class="btn btn-lg btn-primary rounded" href="">
                <i class="bi bi-arrow-right"></i>
              </a>
            </div>
